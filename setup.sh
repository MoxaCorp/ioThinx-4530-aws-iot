...
GIT_SDK=https://github.com/aws/aws-iot-device-sdk-cpp.git
VER_SDK=v1.4.0
SRC_TOOLCHAIN=/usr/local/arm-linux-gnueabihf

SRC_ROOTFS=$DIR_WRK/rootfs
DST_SDK=$DIR_WRK/output/sdk_aws
DST_TOOLCHAIN=$DIR_WRK/output/env_aws
DST_ROOTFS=$DST_TOOLCHAIN/arm-linux-gnueabihf

CMAKE_SAMPLE=$DST_SDK/CMakeLists.txt
